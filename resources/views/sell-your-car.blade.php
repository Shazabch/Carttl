            ...
            <div class="col-lg-8">
                <div class="sell-your-car">
                    <form>
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="h-28 mb-4">Fill all details about your car</h2>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="tel" class="form-control" id="phone" placeholder="e.g. 0300 1234567">
                            </div>
                            <div class="col-lg-6 mb-3">
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="year" placeholder="e.g. 2022" min="1990" max="2099">
                            </div>
                            <div class="col-lg-6 mb-3">
                                <label for="mileage" class="form-label">Mileage</label>
                                <input type="number" class="form-control" id="mileage" placeholder="e.g. 50,000 km">
                            </div>
                            <div class="col-lg-12 mb-3">
                                <label for="specs" class="form-label">Specifications</label>
                                <textarea class="form-control" id="specs" rows="3" placeholder="Mention car features, condition, etc."></textarea>
                            </div>
                            <div class="col-lg-12 mb-4">
                                <label class="form-label">Are you looking to Trade-In?</label>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="tradeIn" id="tradeYes" value="Yes">
                                    <label class="form-check-label" for="tradeYes">Yes</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="tradeIn" id="tradeNo" value="No">
                                    <label class="form-check-label" for="tradeNo">No</label>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <button type="submit" class="btn btn-dark w-100 py-3 fw-bold">Submit Details</button>
                            </div>
                        </div>
                    </form>
                </div>
