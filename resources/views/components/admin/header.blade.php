...
<head>
    ...
    <meta name="description"
        content="Sultan traders admin dashboard live demo. Check out all the features of the admin panel. A large number of settings, additional services and widgets." />
    ...
    <style>
        .auto-item-id {
            background-color: #80c783 !important;
...
<body id="kt_body"
            ...
            <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="brand flex-column-auto" id="kt_brand">
                    ...
                    <a href="{{ route('dashboard') }}" class="brand-logo">
                        <div class="d-flex flex-center">
                            <h3 class="font-weight-boldest text-primary">
                                Sultan <span class="text-danger">Traders</span>
                            </h3>
                ...
                <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                        ...
                        <!--begin::Menu Nav-->
                        <ul class="menu-nav">
                            <li class="menu-item {{ activeByFirstSegment('dashboard') }}" aria-haspopup="true">
                            ...
                            @can('user-management')
                                <li class="menu-item {{ activeByFirstSegment('users') }}" aria-haspopup="true">
                                    <a href="{{ route('users') }}" class="menu-link">
                                        ...
                                        <span class="menu-text">User Mangement</span>
                                    </a>
                                </li>
                            @endcan
                            @can('role-management')
                                <li class="menu-item {{ activeByFirstSegment('roles') }}" aria-haspopup="true">
                                    <a href="{{ route('roles') }}" class="menu-link">
                                        ...
                                        <span class="menu-text">Role Mangement</span>
                                    </a>
                                </li>
                            @endcan
                            ...
                            {{-- @can('reporting-management')
                            <li class="menu-item {{ activeByFirstSegment('reporting-management-list') }}" aria-haspopup="true">
                                <a href="{{ route('reporting.management') }}" class="menu-link">
                                    <span class="svg-icon menu-icon">
                                        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                                    ...
                                    <span class="menu-text">Reporting Management</span>
                                </a>
                            </li>
                            @endcan --}}
                            ...
                            {{-- <li class="menu-section">
									<h4 class="menu-text">Reportings</h4>
									<i class="menu-icon ki ki-bold-more-hor icon-md"></i>
								</li>
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                            ...
                            <div id="kt_header_menu"
                                ...
                                <div class="d-flex flex-center">
                                    <h3 class="font-size-h1 font-weight-boldest text-primary">Sultan <span
                                            class="text-danger">Traders</span></h3>
    ...
    {{-- @livewire('dailybook-management-component') --}}
