...
<body id="kt_body"
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="topbar">
                            ...
                            <div class="topbar-item">
                                <div class="btn btn-icon btn-clean btn-lg px-2 position-relative mr-2" id="kt_quick_notification_toggle">
                                    <i class="fas fa-bell text-dark-50 fa-lg"></i>
                                </div>
    ...
    <!--end::Main-->
    <!--Notification::Canvas-->
    <div id="kt_modal_notification" class="offcanvas offcanvas-right p-10">
        ...
        <hr>
        <div class="offcanvas-content pt-0">
            <div class="gutter-b">
                <div class="" style="gap: 20px;">
                    @livewire('admin.notications.notification-popup-management-component')
                </div>
            </div>
        </div>
