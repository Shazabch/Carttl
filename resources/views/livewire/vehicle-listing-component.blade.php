            ...
            <div class="card-slider-wrap">
                <div class="row mb-5 align-items-end">
                    <div class="col-lg-8 mb-4 mb-lg-0">
                        ...
                        <p class="text-secondary mb-0">Looking for your next ride? Check out our featured cars—great
                            deals on the most popular models, all in one place..</p>
                    </div>
                    ...
                    @foreach ($vehicles as $item)
                        @if ($section == 'Vehicles')
                            <div class="car-box-card" data-aos="fade-left" data-aos-delay="0" data-aos-duration="1000"
                                ...
                                <div class="car-box-card-images">
                                    <div class="car-box-card-images-inner">
                                        <a href="{{ route('car-detail-page', $item->id) }}"
                                            class="car-box-card-imag-item">
                                ...
                                <div class="car-box-card-content">
                                    ...
                                    <div class="car-box-price-and-specs">
                                        <div class="car-box-price">
                                            ...
                                            <h4 class="mb-0 car-box-price-text"> {{ format_currency($item->price) }}
                                            </h4>
                                        </div>
                                    </div>
                            ...
                            <a href="{{ route('car-detail-page', $item->id) }}" class="view-detail-btn">Buy Now</a>
                                    ...
                                    <div class="mt-3">
                                        <a href="{{ route('car-detail-page', $item->id) }}" class="view-detail-btn">View
                                            Detail</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="car-box-other-detail">
                                        ...
                                        <div class="car-box-specs">
                                            ...
                                            <div class="spec_item">
                                                ...
                                                <span>Ends In
                                                    {{ \Carbon\Carbon::parse($item->auction_end_date)->shortAbsoluteDiffForHumans() }}</span>
                                            </div>
                                            <div class="spec_item">
