            ...
            <div class="row">
                        ...
                        <div class="card shadow-lg border-0 rounded-lg text-center p-4 p-md-5"
                            ...
                            <div class="card-body">
                                ...
                                <p class="lead text-muted mt-1">
                                    Your vehicle inspection booking has been successfully submitted. Our team will
                                    contact you shortly to confirm the details.
                                </p>
                                <hr class="my-1">
                                <p>
                                    If you have any urgent questions or need to reschedule, feel free to reach out to us
                                    anytime.
                                </p>
                                <p class="text-muted">
                ...
                @else
                    <div class="col-lg-4">
                        <div class="stick-box">
                            <div class="mb-4 pt-4">
                                <h4 class="h-35 fw-700 mb-4">Book Your Vehicle Inspection</h4>
                                <p class="mb-2">
                                    Let us know the car you want to inspect — just fill out the simple form and
                                    ...
                                    <div class="col-lg-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="location"
                                                placeholder="Where should we inspect?" wire:model="location">
                                            @error('location')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
