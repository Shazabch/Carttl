                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <div class="detail-item"><span class="detail-label">No Of
                                                    Cylinders</span><span
                                                    class="detail-value">{{ $selected_vehicle->no_of_cylinder ?? 'NA' }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
            ...
            <div class="col-lg-4">
                ...
                <div class="contact-card my-2">
                    ...
                    <div class="contact-options">
                        <a id="whatsapp-btn" href="https://wa.me/971 54 353 3583" target="_blank"
                    ...
                    <div class="contact-card">
                        ...
                        <div class="contact-options">
                            ...
                            <a href="mailto:info@thegoldenx.com"
                                class="btn btn-outline-primary btn-auto-bid">
                                <i class="fas fa-envelope"></i>
                                Email
                            </a>
                        </div>
...
<script>
    ...
    const phone = "971543533583"; // without the '+'
