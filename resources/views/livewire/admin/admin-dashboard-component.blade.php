                ...
                <div class="card shadow-sm border-0 bg-white">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <a href="{{ route('admin.vehicles','all') }}" class="btn btn-sm btn-warning">Go to Vehicles</a>
                        </div>
                ...
                <div class="card shadow-sm border-0 bg-white">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <a href="{{ route('admin.inspection.enquiries') }}" class="btn btn-sm btn-warning">View Inspections</a>
                        </div>
                        <div class="icon-container text-warning" style="font-size: 2.5rem;">
                ...
                <div class="card shadow-sm border-0 bg-white">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <a href="{{ route('admin.vehicles','listed') }}" class="btn btn-sm btn-warning">View Listings</a>
                        </div>
                        <div class="icon-container text-warning" style="font-size: 2.5rem;">
                ...
                <div class="card shadow-sm border-0 bg-white">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <a href="{{ route('admin.vehicles','sold') }}" class="btn btn-sm btn-warning">View Sold</a>
                        </div>
                        <div class="icon-container text-warning" style="font-size: 2.5rem;">
                ...
                <div class="card shadow-sm border-0 bg-white">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <a href="{{ route('admin.purchase.list') }}" class="btn btn-sm btn-warning">See Enquiries</a>
                        </div>
                        <div class="icon-container text-warning" style="font-size: 2.5rem;">
