<div>
    ...
    <div class="card">
        ...
        <div class="card-body" style="background-color: #f8f9fa;">
            {{-- This is the form for creating/editing a report --}}
            <div class="space-y-4">
                {{-- Step 1 Content --}}
                @if($currentStep === 1)
        ...
        <div class="card-footer d-flex justify-content-between">
            ...
            <div>
                ...
                @if ($currentStep < 3)
                    ...
                    @else
                    <button type="button" class="btn btn-success" wire:click="saveReport">Save Report</button>
                    @endif
            </div>
        </div>
    </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $report->year }}</td>
                            <td>{{ $report->vin }}</td>
                            <td>{{ $report->inspected_at->format('M d, Y') }}</td>
                            <td>
                                <button wire:click="showEditForm({{ $report->id }})" class="btn btn-sm btn-outline-primary">
