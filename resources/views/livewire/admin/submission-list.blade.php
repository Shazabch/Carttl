    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <span class=" font-weight-bold mr-4">Customer Enquiries - GOLDEN X</span>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr wire:key="{{ $submission->id }}">
                            ...
                            <td>
                                @if ($isPrivilegedUser || $user->can('contact-inquiry-view'))
                                <button class="btn btn-sm btn-info" wire:click="view({{ $submission->id }})">
                                    <i class="fas fa-eye"></i> View
                                </button>
                                @endif
                                @if ($isPrivilegedUser || $user->can('contact-inquiry-delete'))
