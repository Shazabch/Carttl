        ...
        <div class="card-body border-bottom">
            <form wire:submit.prevent="saveUser">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label>Password @if(!$editingUserId)<span class="text-danger">*</span>@endif</label>
                        <input type="password" class="form-control" wire:model="password" autocomplete="new-password" placeholder="{{ $editingUserId ? 'Leave blank to keep current' : '' }}">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <div wire:loading wire:target="saveUser" class="spinner-border spinner-border-sm me-1" role="status"></div>
