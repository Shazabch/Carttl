    ...
    <section class="section-blog ox-hidden">
        <div class="container">
            ...
            <div class="row g-4 align-items-stretch">
                <!-- Featured Post -->
                @if ($featuredBlog)
                    <div class="col-lg-6" data-aos="fade-left" data-aos-delay="0" data-aos-duration="1000"
                        ...
                        <div class="featured-post position-relative">
                            ...
                            <div class="featured-content text-white">
                                ...
                                <a href="{{ route('get-blog',$featuredBlog->slug) }}" class="read-more-icon d-inline-block">
