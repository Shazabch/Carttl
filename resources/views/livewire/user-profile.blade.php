<div>
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            {{-- Success Indicator --}}
            <div x-data="{ show: @entangle('showSuccessIndicator') }" x-show="show" x-transition.out.opacity.duration.1500ms x-init="$watch('show', value => { if (value) { setTimeout(() => { show = false }, 2000) } })"
                ...
                <form wire:submit.prevent="save">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('bio') is-invalid @enderror" id="bio" rows="4" wire:model.defer="bio"
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div class="d-flex align-items-center mb-4">
                        <img src="{{ asset('assets/media/users/default.jpg') }}" class="rounded-circle me-3"
                            alt="User Avatar">
                        <div>
            ...
            <form wire:submit.prevent="changePassword">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="password" class="form-control @error('confirm_password') is-invalid @enderror"
                            id="confirm_password" wire:model.defer="confirm_password">
                ...
                <div class="d-flex justify-content-end mt-4">
                    <button type="submit" class="btn btn-accent">
                        ...
                        <span wire:loading wire:target="changePassword"><i
                                class="fas fa-spinner fa-spin me-2"></i>Changing...</span>
                    </button>
                </div>
        </div>
    </div>
