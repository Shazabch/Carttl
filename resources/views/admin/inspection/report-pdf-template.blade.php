...
<body>
    <div class="container">
        ...
        <div class="report-card">
            ...
            <div class="card-body">
                @php
                // Get damage data - you'll need to replace this with actual damage data retrieval
                $damageData = []; // Replace with actual damage data from your model
                // Example: $damageData = $reportInView->damages ?? [];
                @endphp
                ...
                @else
                    <div class="damage-assessment">
                        ...
                        <p style="margin-top: 15px; color: var(--text-muted); font-size: 12px;">
                            This vehicle has been inspected and no significant damage has been identified during the assessment.
                        </p>
                    </div>
                @endif
            </div>
